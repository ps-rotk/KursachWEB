...
<jsp:useBean id="listAnimal" class="java.util.ArrayList" scope="application"/>
<%
...
<form id="checkedForm" action="feed.jsp" method="post">
    <%
        DAO dao = new DAO();
        request.setCharacterEncoding("UTF-8");
        listAnimal = dao.getAllAnimals();
        if (request.getParameter("action") != null) {
            if (request.getParameter("idAnimal") != null) {
                if (request.getParameter("idAnimal").equals("")) {
    ...
    <div style="padding: 5px;">
        <button type="button" name="action" onclick="location.href ='inputAnimals.jsp'" value="Add">Добавить новое животное
        </button>
...
<%
    ...
    for(int i=0; i<listAnimal.size();i++) {
        Object o=listAnimal.get(i);
        Animal animal =(Animal) o; //TODO: вывод ниже пофиксь пж
